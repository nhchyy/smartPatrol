 ...
 * 设备修改加运维API
 * @author 作者：杨黎明
 * @param  巡检日志表参数：eqp_id,mtc_type,maintainer_name,maintainer_tel,description
 * @param  设备修改参数：address,longtitude,latitude,principal_name,principal_tel,mfr_tel,comment
 * @return JSON
 */
